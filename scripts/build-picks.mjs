...
const DEAL_KEYWORDS = /등산|트레킹|아웃도어|캠핑|배낭|스틱|헤드랜턴|보호대|양말|장갑|모자|우비|생수|이온|음료|커피|견과|너트|육포|오징어|단백질|프로틴|에너지바|영양바|초콜릿|젤리|양갱|약과|과자|스낵|감자칩|사과|귤|감귤|바나나|토마토|고구마|옥수수|계란|구운란|주먹밥|김밥|홍삼|유산균|비타민|오메가|올리브|선크림|핫팩|물티슈|손소독|구급|밴드/;
