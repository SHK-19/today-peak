...
// 동네 명산 후보. osmName은 OSM 노드 이름(산 이름과 다를 때만), near는 동명이산 선택 힌트.
const WANTED = [
  // 서울
  { name: '인왕산', near: [37.585, 126.958] },
  { name: '북악산', near: [37.593, 126.974] },
  { name: '남산', near: [37.552, 126.988] },
  { name: '안산', displayName: '안산(서대문)', near: [37.577, 126.946] },
  { name: '아차산', near: [37.567, 127.103] },
  { name: '용마산', near: [37.571, 127.096] },
  { name: '불암산', near: [37.664, 127.095] },
  { name: '수락산', near: [37.699, 127.081] },
  { name: '우면산', near: [37.47, 127.009] },
  { name: '대모산', near: [37.475, 127.079] },
  { name: '구룡산', near: [37.469, 127.061] },
  { name: '청계산', near: [37.422, 127.043] },
  { name: '삼성산', near: [37.436, 126.939] },
  { name: '개화산', near: [37.583, 126.805] },
  { name: '봉산', displayName: '봉산(은평)', near: [37.612, 126.901] },
  // 경기·인천
  { name: '검단산', displayName: '검단산(하남)', near: [37.518, 127.249] },
  { name: '예봉산', near: [37.559, 127.261] },
  { name: '운길산', near: [37.573, 127.295] },
  { name: '남한산', near: [37.481, 127.204] },
  { name: '계양산', near: [37.553, 126.715] },
  { name: '소래산', near: [37.452, 126.779] },
  { name: '문수산', displayName: '문수산(김포)', near: [37.739, 126.549] },
  { name: '고려산', near: [37.744, 126.437] },
  { name: '모락산', near: [37.371, 126.979] },
  { name: '백운산', displayName: '백운산(의왕)', near: [37.354, 127.017] },
  { name: '광교산', osmName: '광교산 시루봉', peakName: '시루봉', near: [37.345, 127.034] },
  { name: '노고산', displayName: '노고산(고양)', near: [37.685, 126.944] },
  { name: '앵자봉', near: [37.416, 127.398] },
  { name: '불곡산', displayName: '불곡산(성남)', near: [37.352, 127.134] },
  { name: '석성산', near: [37.273, 127.173] },
];
